...
const SERVICE_BUTTON_CONFIG = [
  ...
  { key: 'CARD_CREATED_GENERAL', label: 'General Card Created', icon: CreditCard, accent: 'bg-blue-100 text-blue-700 border-blue-200' },
  ...
  { key: 'CARD_REACTIVATION_GENERAL', label: 'General Card Reactivation', icon: CreditCard, accent: 'bg-sky-100 text-sky-700 border-sky-200' },
  ...
  { key: 'CONSULTATION_GENERAL', label: 'Consultation (General)', icon: User, accent: 'bg-teal-100 text-teal-700 border-teal-200' },
