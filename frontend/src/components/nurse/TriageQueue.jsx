              ...
              <form onSubmit={handleVitalsSubmit} className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors border flex items-center ${activeSection === 'vitals'
                        ? 'bg-blue-600 text-white border-blue-600 shadow-sm'
                        : sectionCompletion.vitals
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors border flex items-center ${activeSection === 'complaint'
                        ? 'bg-blue-600 text-white border-blue-600 shadow-sm'
                        : sectionCompletion.complaint
                          ? 'bg-green-100 text-green-800 border-green-200 hover:bg-green-200'
                          : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors border flex items-center ${activeSection === 'examination'
                        ? 'bg-blue-600 text-white border-blue-600 shadow-sm'
                        : sectionCompletion.examination
                          ? 'bg-green-100 text-green-800 border-green-200 hover:bg-green-200'
                          : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setActiveSection('nurseService')}
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors border flex items-center ${activeSection === 'nurseService'
                        ? 'bg-blue-600 text-white border-blue-600 shadow-sm'
                        : sectionCompletion.nurseService
                          ? 'bg-green-100 text-green-800 border-green-200 hover:bg-green-200'
                          : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setActiveSection('dentalService')}
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors border flex items-center ${activeSection === 'dentalService'
                        ? 'bg-blue-600 text-white border-blue-600 shadow-sm'
                        : sectionCompletion.dentalService
                          ? 'bg-green-100 text-green-800 border-green-200 hover:bg-green-200'
                          : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => setActiveSection('materialNeeds')}
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors border flex items-center ${activeSection === 'materialNeeds'
                        ? 'bg-blue-600 text-white border-blue-600 shadow-sm'
                        : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors border flex items-center ${activeSection === 'assignment'
                        ? 'bg-blue-600 text-white border-blue-600 shadow-sm'
                        : sectionCompletion.assignment
                          ? 'bg-green-100 text-green-800 border-green-200 hover:bg-green-200'
                          : 'bg-white text-gray-700 border-gray-200 hover:bg-gray-50'
                      }`}
                  >
                ...
                <div className="space-y-4">
                  ...
                  {selectedPatient && activeSection === 'materialNeeds' && (
                    <div className="border border-gray-200 rounded-lg p-6">
                ...
                <div className="flex justify-end space-x-3 pt-4">
                  ...
                  <button
                    type="submit"
                    className={`btn ${(sectionCompletion.assignment || sectionCompletion.nurseService) && !isSubmitting
                      ? 'btn-primary'
                      : 'btn-disabled'
                      }`}
