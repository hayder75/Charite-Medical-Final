...
const DESIRED_CBC_FIELDS = [
  { fieldName: 'wbc', label: 'WBC', unit: '×10³/µL' },
  { fieldName: 'lymph_abs', label: 'Lymph#', unit: '×10³/µL' },
  { fieldName: 'mid_abs', label: 'Mid#', unit: '×10³/µL' },
  { fieldName: 'gran_abs', label: 'Gran#', unit: '×10³/µL' },
  ...
  { fieldName: 'rbc', label: 'RBC', unit: '×10⁶/µL' },
  ...
  { fieldName: 'plt', label: 'PLT', unit: '×10³/µL' },
