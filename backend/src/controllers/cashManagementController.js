...
const ACCEPTED_SERVICE_BUCKETS = {
  ...
  CARD_CREATED_GENERAL: { label: 'General Card Created' },
  CARD_CREATED_DERMATOLOGY: { label: 'Dermatology Card Created' },
  CARD_REACTIVATION_GENERAL: { label: 'General Card Reactivation' },
  CARD_REACTIVATION_DERMATOLOGY: { label: 'Dermatology Card Reactivation' },
  CONSULTATION_GENERAL: { label: 'Consultation (General)' },
